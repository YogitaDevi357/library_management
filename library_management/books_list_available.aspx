<%@ Page Language="C#" AutoEventWireup="true" CodeFile ="books_list_available.aspx.cs" Inherits="library_management.books_list_available" %>
        ...
        <table class="style1">
            <tr>
                <td colspan="2" 
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="style3">LIST OF BOOKS AVAILABLE</span></span><br />
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                        DataSourceID="sql_book" CellPadding="4" ForeColor="#333333" 
